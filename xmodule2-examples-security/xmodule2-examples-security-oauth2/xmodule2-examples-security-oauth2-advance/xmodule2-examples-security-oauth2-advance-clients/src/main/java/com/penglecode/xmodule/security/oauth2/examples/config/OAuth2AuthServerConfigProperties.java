...
@Configuration
public class OAuth2AuthServerConfigProperties implements InitializingBean {
	...
	private UserStorageProviderConfigProperties userStorageProvider;
	...
	@Bean
	@ConfigurationProperties(prefix="spring.security.oauth2.user-storage-provider")
	protected UserStorageProviderConfigProperties userStorageProvider() {
		return new UserStorageProviderConfigProperties();
	}
	
	@Bean
	@ConfigurationProperties(prefix="spring.security.oauth2.client.registration.default-client-authorization-code")
	protected OAuth2ClientConfigProperties authorizationCodeClient() {
		return new OAuth2ClientConfigProperties();
	}
	
	@Bean
	@ConfigurationProperties(prefix="spring.security.oauth2.client.registration.default-client-client-credentials")
	protected OAuth2ClientConfigProperties clientCredentialsClient() {
		return new OAuth2ClientConfigProperties();
	}
	
	@Bean
	@ConfigurationProperties(prefix="spring.security.oauth2.client.registration.default-client-password")
	...
	public UserStorageProviderConfigProperties getUserStorageProvider() {
	...
	public static class UserStorageProviderConfigProperties {
