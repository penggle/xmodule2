...
/**
 * SpringSecurity5 OAuth2客户端配置
 * 
 * 详细教程见：https://docs.spring.io/spring-security/site/docs/current/reference/html5/#oauth2client
 * 
 * @author 	pengpeng
 * @date	2019年12月14日 下午2:45:06
 */
@Configuration
public class OAuth2ClientConfiguration {
	...
	protected Function<OAuth2AuthorizeRequest, Map<String, Object>> contextAttributesMapper() {
