...
public interface UpmsUserRepository {
	 ...
	 * @return
	 */
	public UpmsUser getUserById(String userId);
	 ...
	 * @return
	 */
	public List<UpmsRole> getUserRoles(String userId);
	 ...
	 * @return
	 */
	public List<UpmsUser> getGroupMembers(String groupId);
	 ...
	 * @return
	 */
	public List<UpmsUser> getGroupMembers(String groupId, Integer offset, Integer limit);
