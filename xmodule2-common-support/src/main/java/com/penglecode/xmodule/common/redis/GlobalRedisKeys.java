...
public final class GlobalRedisKeys {
	...
	private static final Constant<String> GLOBAL_KEY_PREFIX = new Constant<String>("spring.redis.common.global-key-prefix", "") {};
	...
	public static String ofKey(String bizKey) {
		return GLOBAL_KEY_PREFIX.value() + bizKey;
	}
	...
	public static String ofKey(String bizPrefix, String bizKey) {
		return GLOBAL_KEY_PREFIX.value() + bizPrefix + bizKey;
	}
	...
	public static String fromKey(String fullKey) {
		return StringUtils.stripStart(fullKey, GLOBAL_KEY_PREFIX.value());
	}
	...
	public static String fromKey(String fullKey, String bizPrefix) {
		return StringUtils.stripStart(fullKey, GLOBAL_KEY_PREFIX.value() + bizPrefix);
	}
